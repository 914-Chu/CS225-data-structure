...
==31792== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==31792== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==31792== Command: ./test -r xml "List::insertFront\ size"
==31792== 
==31792== Conditional jump or move depends on uninitialised value(s)
==31792==    at 0x4364DC: List<int>::insertFront(int const&) (List.hpp:75)
==31792==    by 0x4302B7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==31792==    by 0x4722F2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==31792==    by 0x462A46: Catch::TestCase::invoke() const (catch.hpp:10793)
==31792==    by 0x46297C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==31792==    by 0x45EED6: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==31792==    by 0x45D4AE: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==31792==    by 0x466846: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==31792==    by 0x4654E2: Catch::Session::runInternal() (catch.hpp:10149)
==31792==    by 0x4651AA: Catch::Session::run() (catch.hpp:10106)
==31792==    by 0x465129: Catch::Session::run(int, char**) (catch.hpp:10074)
==31792==    by 0x4921A1: main (catch.hpp:13613)
==31792== 
==31792== Conditional jump or move depends on uninitialised value(s)
==31792==    at 0x436516: List<int>::insertFront(int const&) (List.hpp:78)
==31792==    by 0x4302B7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==31792==    by 0x4722F2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==31792==    by 0x462A46: Catch::TestCase::invoke() const (catch.hpp:10793)
==31792==    by 0x46297C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==31792== 
==31792== Conditional jump or move depends on uninitialised value(s)
==31792==    at 0x462AF0: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==31792==    by 0x4409CB: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==31792==    by 0x430414: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==31792==    by 0x4722F2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==31792==    by 0x462A46: Catch::TestCase::invoke() const (catch.hpp:10793)
==31792==    by 0x46297C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==31792==    by 0x45EED6: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==31792== 
==31792== HEAP SUMMARY:
==31792==     in use at exit: 240 bytes in 10 blocks
==31792==   total heap usage: 2,347 allocs, 2,337 frees, 268,272 bytes allocated
==31792== 
==31792== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==31792==    at 0x4C29EA3: malloc (vg_replace_malloc.c:309)
==31792==    by 0x4E53F8B: operator new(unsigned long) (stdlib_new_delete.cpp:33)
==31792==    by 0x436493: List<int>::insertFront(int const&) (List.hpp:71)
==31792==    by 0x4302B7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==31792==    by 0x4722F2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==31792==    by 0x462A46: Catch::TestCase::invoke() const (catch.hpp:10793)
==31792==    by 0x46297C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==31792== 
==31792== LEAK SUMMARY:
==31792==    definitely lost: 240 bytes in 10 blocks
...
==31792== Use --track-origins=yes to see where uninitialised values come from
==31792== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
==31839== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==31839== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==31839== Command: ./test -r xml "List::_destroy\ empty\ list"
==31839== 
==31839== 
==31839== HEAP SUMMARY:
==31839==     in use at exit: 0 bytes in 0 blocks
==31839==   total heap usage: 2,355 allocs, 2,355 frees, 269,104 bytes allocated
==31839== 
