...
```
==6609== Memcheck, a memory error detector
==6609== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==6609== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==6609== Command: ./test -r xml "List::insertFront\ size"
==6609== 
==6609== Conditional jump or move depends on uninitialised value(s)
==6609==    at 0x4364DC: List<int>::insertFront(int const&) (List.hpp:75)
==6609==    by 0x4302B7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==6609==    by 0x4722F2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==6609==    by 0x462A46: Catch::TestCase::invoke() const (catch.hpp:10793)
==6609==    by 0x46297C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==6609==    by 0x45EED6: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==6609==    by 0x45D4AE: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==6609==    by 0x466846: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==6609==    by 0x4654E2: Catch::Session::runInternal() (catch.hpp:10149)
==6609==    by 0x4651AA: Catch::Session::run() (catch.hpp:10106)
==6609==    by 0x465129: Catch::Session::run(int, char**) (catch.hpp:10074)
==6609==    by 0x4921A1: main (catch.hpp:13613)
==6609== 
==6609== Conditional jump or move depends on uninitialised value(s)
==6609==    at 0x436516: List<int>::insertFront(int const&) (List.hpp:78)
==6609==    by 0x4302B7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==6609==    by 0x4722F2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==6609==    by 0x462A46: Catch::TestCase::invoke() const (catch.hpp:10793)
==6609==    by 0x46297C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==6609== 
==6609== Conditional jump or move depends on uninitialised value(s)
==6609==    at 0x462AF0: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==6609==    by 0x4409CB: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==6609==    by 0x430414: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==6609==    by 0x4722F2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==6609==    by 0x462A46: Catch::TestCase::invoke() const (catch.hpp:10793)
==6609==    by 0x46297C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==6609==    by 0x45EED6: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==6609== 
==6609== HEAP SUMMARY:
==6609==     in use at exit: 240 bytes in 10 blocks
==6609==   total heap usage: 2,347 allocs, 2,337 frees, 268,272 bytes allocated
==6609== 
==6609== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==6609==    at 0x4C29EA3: malloc (vg_replace_malloc.c:309)
==6609==    by 0x4E53F8B: operator new(unsigned long) (stdlib_new_delete.cpp:33)
==6609==    by 0x436493: List<int>::insertFront(int const&) (List.hpp:71)
==6609==    by 0x4302B7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==6609==    by 0x4722F2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==6609==    by 0x462A46: Catch::TestCase::invoke() const (catch.hpp:10793)
==6609==    by 0x46297C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==6609== 
==6609== LEAK SUMMARY:
==6609==    definitely lost: 240 bytes in 10 blocks
==6609==    indirectly lost: 0 bytes in 0 blocks
==6609==      possibly lost: 0 bytes in 0 blocks
==6609==    still reachable: 0 bytes in 0 blocks
==6609==         suppressed: 0 bytes in 0 blocks
==6609== 
==6609== For counts of detected and suppressed errors, rerun with: -v
==6609== Use --track-origins=yes to see where uninitialised values come from
==6609== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
```
==6623== Memcheck, a memory error detector
==6623== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==6623== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==6623== Command: ./test -r xml "List::_destroy\ empty\ list"
==6623== 
==6623== 
==6623== HEAP SUMMARY:
==6623==     in use at exit: 0 bytes in 0 blocks
==6623==   total heap usage: 2,355 allocs, 2,355 frees, 269,104 bytes allocated
==6623== 
==6623== All heap blocks were freed -- no leaks are possible
==6623== 
==6623== For counts of detected and suppressed errors, rerun with: -v
==6623== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
