...
==5068== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==5068== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==5068== Command: ./test -r xml "test_the_works"
==5068== 
==5068== 
==5068== HEAP SUMMARY:
==5068==     in use at exit: 0 bytes in 0 blocks
==5068==   total heap usage: 1,903 allocs, 1,903 frees, 305,664 bytes allocated
==5068== 
==5068== All heap blocks were freed -- no leaks are possible
==5068== 
==5068== For counts of detected and suppressed errors, rerun with: -v
==5068== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
