...
==30421== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==30421== Command: ./test -r xml "List::insertFront\ size"
==30421== 
==30421== Conditional jump or move depends on uninitialised value(s)
==30421==    at 0x42831C: List<int>::insertFront(int const&) (List.hpp:75)
==30421==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==30421==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==30421==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==30421==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==30421==    by 0x44EB46: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==30421==    by 0x44D11E: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==30421==    by 0x4564B6: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==30421==    by 0x455152: Catch::Session::runInternal() (catch.hpp:10149)
==30421==    by 0x454E1A: Catch::Session::run() (catch.hpp:10106)
==30421==    by 0x454D99: Catch::Session::run(int, char**) (catch.hpp:10074)
==30421==    by 0x481E11: main (catch.hpp:13613)
==30421== 
==30421== Conditional jump or move depends on uninitialised value(s)
==30421==    at 0x428356: List<int>::insertFront(int const&) (List.hpp:78)
==30421==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==30421==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==30421==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==30421==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==30421== 
==30421== Conditional jump or move depends on uninitialised value(s)
==30421==    at 0x452760: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==30421==    by 0x43063B: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==30421==    by 0x422154: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==30421==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==30421==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==30421==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==30421==    by 0x44EB46: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==30421== 
==30421== HEAP SUMMARY:
==30421==     in use at exit: 240 bytes in 10 blocks
==30421==   total heap usage: 2,132 allocs, 2,122 frees, 252,400 bytes allocated
==30421== 
==30421== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==30421==    at 0x4C29EA3: malloc (vg_replace_malloc.c:309)
==30421==    by 0x4E53F8B: operator new(unsigned long) (stdlib_new_delete.cpp:33)
==30421==    by 0x4282D3: List<int>::insertFront(int const&) (List.hpp:71)
==30421==    by 0x421FF7: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==30421==    by 0x461F62: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==30421==    by 0x4526B6: Catch::TestCase::invoke() const (catch.hpp:10793)
==30421==    by 0x4525EC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==30421== 
==30421== LEAK SUMMARY:
==30421==    definitely lost: 240 bytes in 10 blocks
==30421==    indirectly lost: 0 bytes in 0 blocks
==30421==      possibly lost: 0 bytes in 0 blocks
==30421==    still reachable: 0 bytes in 0 blocks
==30421==         suppressed: 0 bytes in 0 blocks
==30421== 
==30421== For counts of detected and suppressed errors, rerun with: -v
==30421== Use --track-origins=yes to see where uninitialised values come from
==30421== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
```
==30453== Memcheck, a memory error detector
==30453== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==30453== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==30453== Command: ./test -r xml "List::_destroy\ empty\ list"
==30453== 
==30453== 
==30453== HEAP SUMMARY:
==30453==     in use at exit: 0 bytes in 0 blocks
==30453==   total heap usage: 2,140 allocs, 2,140 frees, 253,232 bytes allocated
==30453== 
==30453== All heap blocks were freed -- no leaks are possible
==30453== 
==30453== For counts of detected and suppressed errors, rerun with: -v
==30453== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
...
This report was generated for **chiaiic2** using **29166f0da09d51508f2cb663608e5da2fd08a43e** (from **February 24th 2020, 11:59:59 pm**)
