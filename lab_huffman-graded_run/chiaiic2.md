...
```
==1778== Memcheck, a memory error detector
==1778== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==1778== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==1778== Command: ./test -r xml "test_the_works"
==1778== 
==1778== 
==1778== HEAP SUMMARY:
==1778==     in use at exit: 0 bytes in 0 blocks
==1778==   total heap usage: 1,903 allocs, 1,903 frees, 305,664 bytes allocated
==1778== 
==1778== All heap blocks were freed -- no leaks are possible
==1778== 
==1778== For counts of detected and suppressed errors, rerun with: -v
==1778== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
...
This report was generated for **chiaiic2** using **764a0c4a006f4924ca2f2a7f5dc9a425c4a1fc20** (from **March 8th 2020, 11:59:59 pm**)
